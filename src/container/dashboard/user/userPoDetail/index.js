...
import { PoSummary, PoDetailTable, PageHeader, TableHeader } from "../../style";
...
const Index = () => {
  ...
  const columnDefinitions = [
    ...
    },
    {
      ...
      type: 'rightAligned',
      cellRendererFramework: () => {
        return <a href="#"><i className="text-error icon-trash"></i></a>;
      },
    },
  ];
    ...
    <>
      ...
      <PageHeader className="d-flex justify-content-between align-items-center">
        ...
        <div className="page-header-extras">
          <ul>
            <li><Button outlined><i className="icon-upload-invoice"></i>Upload Invoice</Button></li>
          </ul>
        </div>
      </PageHeader>
